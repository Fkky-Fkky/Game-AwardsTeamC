...
void RightBeat::Ready(SimpleMath::Vector3 player_pos) {	//çUåÇÇ…ïKópÇ»ïœêîÇÃê›íË
...
void RightBeat::RightBeatAttack(Boss* boss) {	//í@Ç´Ç¬ÇØçUåÇ
...
void RightBeat::HandReturn() {	//éËÇèâä˙à íuÇ÷à⁄ìÆ
