...
void boss::DoubleSlap::HandCheck(const ObjectManager* const obj_m) {	//手の状態を確認
...
void boss::DoubleSlap::Ready(ActionManager* const act_m) {	//予備動作
...
void boss::DoubleSlap::Attack(ActionManager* const act_m) {	//薙ぎ払い攻撃
...
void boss::DoubleSlap::SlapR(ActionManager* const act_m) {	//右手薙ぎ払い
...
void boss::DoubleSlap::SlapL(ActionManager* const act_m) {	//左手薙ぎ払い
