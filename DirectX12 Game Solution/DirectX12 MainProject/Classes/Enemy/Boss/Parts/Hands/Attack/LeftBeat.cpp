...
void boss::LeftBeat::HandCheck(const HandManager* const hand_m) {	//手の状態を確認
...
void boss::LeftBeat::LeftBeatAttack(HandManager* const hand_m) { //叩きつけ攻撃
...
void boss::LeftBeat::Wait(HandManager* const hand_m) {	//硬直
