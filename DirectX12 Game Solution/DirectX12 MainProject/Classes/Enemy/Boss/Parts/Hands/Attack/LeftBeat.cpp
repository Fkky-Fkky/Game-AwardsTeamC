...
void LeftBeat::Ready(SimpleMath::Vector3 player_pos) { //çUåÇÇ…ïKópÇ»ïœêîÇÃê›íË
...
void LeftBeat::LeftBeatAttack(Boss* boss) { //í@Ç´Ç¬ÇØçUåÇ
...
void LeftBeat::HandReturn() { //éËÇèâä˙à íuÇ÷à⁄ìÆ
