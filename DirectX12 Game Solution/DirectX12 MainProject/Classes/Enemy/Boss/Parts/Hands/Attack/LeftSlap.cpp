...
void boss::LeftSlap::HandCheck(const ObjectManager* const obj_m) {	//手の状態を確認
...
void boss::LeftSlap::Ready(ActionManager* const act_m) {	//予備動作
...
void boss::LeftSlap::Wait(ActionManager* const act_m) {	//待機
...
void boss::LeftSlap::LeftSlapAttack(ActionManager* const act_m) {	//左手薙ぎ払い攻撃
