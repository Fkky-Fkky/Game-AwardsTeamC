...
PlayerTestScene::PlayerTestScene() : dx9GpuDescriptor{}
{
...
void PlayerTestScene::Terminate()
{
...
void PlayerTestScene::OnDeviceLost()
{

}

// Restart any looped sounds here
void PlayerTestScene::OnRestartSound()
{

}

// Updates the scene.
NextScene PlayerTestScene::Update(const float deltaTime)
{
    ...
    player.HitPlayer(object_manager_.GetPlayerDmgFlag());
    boss.Update(deltaTime, &object_manager_);
